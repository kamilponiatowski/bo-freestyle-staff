<template>
  <div id="app">
    <header>
      <div class="container">
        <div class="logo">
          ...
          <span>Freestyle Staff Academy</span>
        </div>
      </div>
    </header>
    ...
    <nav>
      <div class="container">
        <ul>
          ...
          <li>
            <router-link to="/library">Biblioteka</router-link>
          </li>
          <li>
    ...
    <footer>
      <div class="container">
        <p>Freestyle Staff Academy - Tracker Postępów dla Muszki</p>
        <p>Stworzono z <span class="footer-heart">❤</span> przez Żuczka</p>
      </div>
    </footer>
